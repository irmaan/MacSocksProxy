...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    if (autoLaunch) {
        // reenable
        SMLoginItemSetEnabled ((__bridge CFStringRef)@"com.mirzanejad.sshproxyhelper", YES);
    } else {
        SMLoginItemSetEnabled ((__bridge CFStringRef)@"com.mirzanejad.sshproxyhelper", NO);
    }
}
