...
-(IBAction)toggleLaunchAtLogin:(id)sender
{
    ...
    if (state == NSOnState) { // ON
        ...
        if (!SMLoginItemSetEnabled ((__bridge CFStringRef)@"com.mirzanejad.sshproxyhelper", YES)) {
    ...
    if (state == NSOffState) { // OFF
        ...
        if (!SMLoginItemSetEnabled ((__bridge CFStringRef)@"com.mirzanejad.sshproxyhelper", NO)) {
            NSAlert *alert = [NSAlert alertWithMessageText:@"An error ocurred"
                                             defaultButton:@"OK"
                                           alternateButton:nil
                                               otherButton:nil
